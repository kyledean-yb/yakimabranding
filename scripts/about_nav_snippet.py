...
def about_nav_dropdown(prefix: str, active: Optional[str] = None, lang: str = "en") -> str:
    ...
    return f"""        <div class="nav-dd nav-dd-about">
          ...
          <div class="nav-dd-about-inner">
            <div class="nav-dd-about-banner">
              <span class="nav-dd-eyebrow">{t("About YB Marketing", lang)}</span>
              <p class="nav-dd-banner-text">{t("Pacific Northwest agency · Washington State", lang)}</p>
            </div>
            <div class="nav-dd-about-grid">
              <a href="{page_href_lang('about.html', lang)}" class="dd-card{about_cls}">
                ...
                <div><span class="dd-name">{t("About Us", lang)}</span><span class="dd-desc">{t("Meet our team & our story", lang)}</span></div>
              </a>
              <a href="{page_href_lang('about/case-studies/index.html', lang)}" class="dd-card{cases_cls}">
                <div class="dd-ic" style="background:var(--wash-violet);color:var(--yb-violet)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><line x1="8" y1="7" x2="16" y2="7"/><line x1="8" y1="11" x2="14" y2="11"/></svg></div>
                <div><span class="dd-name">{t("Case Studies", lang)}</span><span class="dd-desc">{t("Client results & project highlights", lang)}</span></div>
              </a>
              <a href="{page_href_lang('washington-state-sales-tax.html', lang)}" class="dd-card{tax_cls}">
                <div class="dd-ic" style="background:#e8f5ee;color:#2d9a5a"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></div>
                <div><span class="dd-name">{t("WA Sales Tax Notice", lang)}</span><span class="dd-desc">{t("Oct 2025 advertising & software tax info", lang)}</span></div>
              </a>
            </div>
          </div>
        </div>"""
...
def about_nav_shell(
    ...
    return f"""      <div class="nav-about" id="navAbout">
        <button class="nav-svc-btn" type="button"{style_attr}>{t("About", lang)}
...
{about_nav_dropdown(prefix, active, lang)}
      </div>"""
