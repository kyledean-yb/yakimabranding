...
<section class="svc-hero">
  ...
  <div class="container svc-hero-inner">
    ...
    <div class="svc-hero-visual">
      <div class="img-ph" style="min-height:320px;background:linear-gradient(145deg,rgba(63,111,214,.25),rgba(61,196,232,.18));border:1px solid rgba(255,255,255,.12);border-radius:var(--r-xl);display:flex;align-items:center;justify-content:center;padding:40px">
        <div style="text-align:center;color:#fff">
          <div style="width:72px;height:72px;margin:0 auto 18px;border-radius:var(--r-lg);background:rgba(255,255,255,.12);display:flex;align-items:center;justify-content:center;color:var(--yb-cyan)">{ICON_SVG.replace('stroke-width="2"', 'stroke-width="1.8" width="36" height="36"')}</div>
          <div style="font-family:var(--font-display);font-weight:800;font-size:1.25rem;margin-bottom:8px">One place for growth</div>
          <p style="color:var(--fg2-on-dark);font-size:14px;line-height:1.55;max-width:260px;margin:0 auto">Leads, conversations, automation, and follow-up — connected.</p>
        </div>
      </div>
    </div>
  </div>
