...
.video-list{{display:grid;gap:40px}}
.video-card{{position:relative;z-index:auto;display:grid;grid-template-columns:1.05fr .95fr;gap:28px;align-items:center;background:#fff;border:1px solid var(--line);border-radius:var(--r-xl);padding:20px;box-shadow:0 2px 12px rgba(22,32,58,.05)}}
