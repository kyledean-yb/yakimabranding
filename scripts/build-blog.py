      ...
      <div class="nav-services" id="navServices">
        ...
        <div class="nav-dd">
          ...
          <div class="nav-dd-grid">
            ...
            <a href=\"{prefix}services/customer-growth.html" class="dd-card"><div class="dd-ic" style="background:var(--wash-blue);color:var(--yb-blue)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div><div><span class="dd-name">Customer Growth & Communication Tool</span><span class="dd-desc">CRM, messaging & automation</span></div></a>
          </div>
        </div>
      </div>
...
@media(max-width:1100px){{.nav,.btn-hdr{{display:none}}.hamburger{{display:flex}}.nav-dd{{display:none}}}}
</style>
{extra_head}
{TRACKING_HEAD_BLOCK}
</head>
