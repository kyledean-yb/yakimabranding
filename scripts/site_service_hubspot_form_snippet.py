...
SERVICE_THANK_YOU = {
    "seo.html": "thank-you-seo.html",
    "google-ads.html": "thank-you-google-ads.html",
    "web-design.html": "thank-you-web-design.html",
    "social-media.html": "thank-you-social-media.html",
    "branding.html": "thank-you-branding.html",
    "content-creation.html": "thank-you-content-creation.html",
    "press-releases.html": "thank-you-press-releases.html",
}


def service_thank_you_redirect(service_filename: str) -> str:
    return SERVICE_THANK_YOU.get(service_filename, "../thank-you.html")


def service_hubspot_form_html(source: str, redirect: Optional[str] = None) -> str:
    redirect = redirect or "../thank-you.html"
